...
export function formatStructuredContext(contextData) {
  ...
  if (analytics) {
    ...
    performance.winRate = ((analytics.winRate || 0) * 100).toFixed(1)
    performance.profitFactor = (analytics.profitFactor || 0).toFixed(2)
    ...
    performance.maxDrawdown = analytics.maxDrawdown ? (analytics.maxDrawdown * 100).toFixed(1) : null
    performance.sharpeRatio = analytics.sharpeRatio !== undefined && analytics.sharpeRatio !== null ? analytics.sharpeRatio.toFixed(2) : null
...
- Use headings when discussing multiple topics
