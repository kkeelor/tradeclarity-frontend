 ...
 * Supports: ALPHA_VANTAGE_API_KEY (single) or ALPHA_VANTAGE_API_KEY_1, _2, _3, etc. (multiple)
...
function getAPIKeys() {
  ...
  // Try to get multiple numbered keys (ALPHA_VANTAGE_API_KEY_1, _2, _3, etc.)
  ...
  if (keys.length === 0) {
    console.error('[MCP Client] No API keys found. Set ALPHA_VANTAGE_API_KEY or ALPHA_VANTAGE_API_KEY_1, _2, _3, etc.')
