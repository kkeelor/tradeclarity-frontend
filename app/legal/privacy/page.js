    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold text-white/90">Privacy Policy</h1>
        </div>
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-white/70">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">1. Information We Collect</h2>
            
            <h3 className="text-xl font-semibold text-white/90 mt-4 mb-3">1.1 Account Information</h3>
            ...
            <h3 className="text-xl font-semibold text-white/90 mt-4 mb-3">1.2 Trading Data</h3>
            ...
            <h3 className="text-xl font-semibold text-white/90 mt-4 mb-3">1.3 Usage Data</h3>
            ...
            <h3 className="text-xl font-semibold text-white/90 mt-4 mb-3">1.4 Payment Information</h3>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">2. How We Use Your Information</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">3. Data Security</h2>
            <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-6">
              <h3 className="font-semibold text-white/90 mb-2">Security Measures</h3>
            ...
            <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-6 mt-4 mb-4">
              <h4 className="font-semibold text-red-400 mb-2">⚠️ Important: API Key Permissions</h4>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">4. Data Sharing and Disclosure</h2>
            <p>We do not sell your personal data. We may share information in the following circumstances:</p>
            
            <h3 className="text-xl font-semibold text-white/90 mt-4 mb-3">4.1 Service Providers</h3>
            ...
            <h3 className="text-xl font-semibold text-white/90 mt-4 mb-3">4.2 Legal Requirements</h3>
            ...
            <h3 className="text-xl font-semibold text-white/90 mt-4 mb-3">4.3 Business Transfers</h3>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">5. Your Rights and Choices</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">6. Data Retention</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">7. Cookies and Tracking</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">8. International Data Transfers</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">9. Children's Privacy</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">10. Changes to This Policy</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">11. Contact Us</h2>
            <p>
