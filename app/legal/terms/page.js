      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-slate-300">
          ...
          <section className="space-y-4">
            ...
            <h3 className="text-xl font-semibold text-white mt-4 mb-3">3.1 Account Creation</h3>
            ...
            <h3 className="text-xl font-semibold text-white mt-4 mb-3">3.2 Account Responsibility</h3>
            <p>
          ...
          <section className="space-y-4">
            ...
            <h3 className="text-xl font-semibold text-white mt-4 mb-3">4.1 Subscription Plans</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-4 mb-3">4.2 Payment</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-4 mb-3">4.3 Auto-Renewal</h3>
            <p>
          ...
          <section className="space-y-4">
            ...
            <h3 className="text-xl font-semibold text-white mt-4 mb-3">5.1 Permitted Use</h3>
