    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold text-white/90">Shipping Policy</h1>
        </div>

        <div className="prose prose-invert max-w-none space-y-8 text-white/70">
          <section className="space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-6">
              <h2 className="text-xl font-semibold text-white/90 mb-2">Digital Service - No Physical Shipping</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">Service Delivery</h2>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white/90 mt-6 mb-3">Instant Access</h3>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">Account Activation</h2>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white/90 mt-6 mb-3">Activation Timeline</h3>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">Digital Products</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">International Access</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">Technical Requirements</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white/90 mb-4">Support</h2>
            <p>
