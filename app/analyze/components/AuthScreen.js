            ...
            {mode === 'signup' && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-slate-900 border-slate-700 text-white placeholder-slate-500 focus:ring-emerald-500/30"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-slate-900 border-slate-700 text-white placeholder-slate-500 focus:ring-emerald-500/30"
                  required
                  disabled={loading}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="????????"
                  className="pl-10 pr-12 bg-slate-900 border-slate-700 text-white placeholder-slate-500 focus:ring-emerald-500/30"
                  required
                  disabled={loading}
                  minLength={6}
                />
